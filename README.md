...
- **设置页面**：外观（浅色/深色/跟随系统 + 主题色）、语言、助手设置（API 密钥、Base URL、模型、预设性格阿喵/阿汪/砖家/小冰/默认、聊天人设、测试连接）、通知设置、使用教程入口
- **使用教程**：7 步交互式引导——欢迎、功能概览、AI 助手对话示例、任务管理操作指南、视图与通知介绍、API 配置、完成。统一卡片高度，导航按钮固定位置。支持从设置页随时重新查看
...
ui/
  ...
  views/settings_view.py    # 设置页（外观/语言/助手设置/通知/教程，LLM 配置表单）
  views/onboarding_view.py  # 教程引导（7 步：欢迎/功能/AI 教程/任务管理/视图通知/API/完成）
